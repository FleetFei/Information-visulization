...
//						unidata[i * size + n] = new Array();
//						unidata[i * size + n][0] = Orgdata[i].university_name;
//						unidata[i * size + n][1] = key;
//						unidata[i * size + n][2] = parseInt(Orgdata[i][key]);
//						n++;
//					}
...
//	var classNames = [];
//	$(thisobj).children().each(function(i) {
...
//var countries=["Harvard University","University of Cambridge"]
